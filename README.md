...
```sh
 ...
 Урок 1.1:  ПЕРЕМЕЩЕНИЕ КУРСОРА (выполнил)
...
Урок 1.2: ЗАВЕРШЕНИЕ РАБОТЫ С VIM (выполнил)
...
Урок 1.3: РЕДАКТИРОВАНИЕ ТЕКСТА -- УДАЛЕНИЕ (выполнил)
...
```sh
   ...
   Урок 1.4: РЕДАКТИРОВАНИЕ ТЕКСТА -- ВСТАВКА (выполнил)
...
```sh
Урок 1.5: РЕДАКТИРОВАНИЕ ТЕКСТА -- ДОБАВЛЕНИЕ (выполнил)
...
```sh
 Урок 1.6: РЕДАКТИРОВАНИЕ ФАЙЛА (выполнил)
...
```sh
Урок 2.1: КОМАНДЫ УДАЛЕНИЯ (выполнил)
...
```sh
   Урок 2.2: ДОПОЛНИТЕЛЬНЫЕ КОМАНДЫ УДАЛЕНИЯ (выполнил)
...
```sh
Урок 2.3: КОМАНДЫ И ОБЪЕКТЫ (изучил)
...
```sh
Урок 2.4: ИСПОЛЬЗОВАНИЕ СЧЁТЧИКА ДЛЯ ПЕРЕМЕЩЕНИЯ (выполнил)
...
```sh
 Урок 2.5: ИСПОЛЬЗОВАНИЕ СЧЁТЧИКА ДЛЯ УДАЛЕНИЯ (выполнил)
...
```sh
Урок 2.6: ОПЕРАЦИИ СО СТРОКАМИ (выполнил)
...
```sh
Урок 2.7: КОМАНДА `ОТМЕНА' (выполнил)
...
```sh
Урок 3.2: КОМАНДА ЗАМЕНЫ (выполнил)
...
```sh
Урок 3.3: КОМАНДА ИЗМЕНЕНИЯ (выполнил)
...
```sh
Урок 3.4: ПРОДОЛЖАЕМ ИЗМЕНЯТЬ С КОМАНДОЙ  c ( выполнил)
...
```sh
Урок 4.1: ИНФОРМАЦИЯ О ФАЙЛЕ И РАСПОЛОЖЕНИИ В НЕМ (выполнил)
...
```sh
Урок 4.2: КОМАНДА ПОИСКА (выполинл)
...
```sh
Урок 4.3: ПОИСК ПАРНЫХ СКОБОК (выполнил)
...
```sh
 Урок 4.4: СПОСОБ ИСПРАВЛЕНИЯ ОШИБОК (выполнил)
...
```sh
Урок 5.1: КАК ВЫПОЛНИТЬ ВНЕШНЮЮ КОМАНДУ (выполнил)
...
```sh
Урок 5.2: КАК ЗАПИСАТЬ ФАЙЛ (выполнил)
...
```sh
 Урок 5.3: ВЫБОРОЧНОЕ СОХРАНЕНИЕ (выполнил)
...
```sh
Урок 5.4: ЧТЕНИЕ И ОБЪЕДИНЕНИЕ ФАЙЛОВ (выполнил)
...
```sh
Урок 6.1: КОМАНДА СОЗДАНИЯ (выполнил)
...
```sh
Урок 6.2: КОМАНДА ДОБАВЛЕНИЯ (выполнил)
  ...
  2. Набирайте  e  пока курсор не переместиться на конец строки.
...
```sh
Урок 6.3: ЕЩЁ ОДИН СПОСОБ ЗАМЕНЫ (выполнил) 
                 (очень круто выглядит, прям в режиме реального времени меняет)
...
```sh
Урок 6.4: КОПИРОВАНИЕ И ВСТАВКА ТЕКСТА (выполнил)
...
```sh
Урок 6.5: УСТАНОВКА ПАРАМЕТРОВ (выполнил)
...
```sh
  Урок 7.1: ВСТРОЕННАЯ СПРАВКА (изучено, т.е. открыл-посмотрел)
...
```sh
Урок 7.2: СОЗДАНИЕ СТАРТОВОГО СЦЕНАРИЯ (файл создан и заполнел)
...
```sh
Урок 7.3: ДОПОЛНЕНИЕ (пробовал, работает)
